    ...
    <main className="min-h-[calc(100vh-var(--header-height))] w-full flex justify-center items-start py-12 px-4 sm:px-6">
      <div className="flex flex-col justify-start items-center h-[calc(100%-var(--back-button-length)-var(--page-padding))] w-[calc(100%-var(--page-padding)*2)] pb-[calc(var(--back-button-length)+var(--page-padding)+80px)] lg:h-[calc(100%-var(--back-button-length)-var(--page-padding-lg))] lg:w-[calc(100%-var(--page-padding-lg)*2)] lg:pb-[calc(var(--back-button-length)+var(--page-padding-lg)+160px)]">
        <div className="w-full flex flex-col justify-center items-center lg:w-1/2">
          <h1 className="text-2xl font-bold mb-12 lg:text-3xl lg:mb-16">利用規約</h1>
          <div className="text-sm mb-6 lg:text-base lg:mb-8">
            この利用規約（以下、「本規約」といいます。）は、試合決めるくん（以下、「当方」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
            登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </div>

          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第1条（適用）</h2>
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第2条（利用登録）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
              <ol className="list-decimal list-inside space-y-2">
                <li>
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第3条（アカウントの管理）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
              <ol className="list-decimal list-inside space-y-2">
                <li>
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第4条（禁止事項）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第5条（本サービスの提供の停止等）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
              <ol className="list-decimal list-inside space-y-2">
                <li>
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第6条（利用制限および登録抹消）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
              <ol className="list-decimal list-inside space-y-2">
                <li>
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第7条（退会）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第8条（保証の否認および免責事項）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
              <ol className="list-decimal list-inside space-y-2">
                <li>
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第9条（サービス内容の変更等）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第10条（利用規約の変更）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
              <ol className="list-decimal list-inside space-y-2">
                <li>
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第11条（個人情報の取扱い）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第12条（通知または連絡）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第13条（権利義務の譲渡の禁止）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
          ...
          <div className="w-full mb-6">
            <h2 className="text-lg font-bold lg:text-xl">第14条（準拠法・裁判管轄）</h2>
            <div className="text-sm ml-4 lg:text-base lg:ml-5">
              <ol className="list-decimal list-inside space-y-2">
                <li>本規約の解釈にあたっては、日本法を準拠法とします。</li>
                <li>本サービスに関して紛争が生じた場合には、サービス提供者の居住地を管轄する裁判所を専属的合意管轄とします。</li>
              </ol>
            </div>
          </div>

          <div className="mt-12 text-sm w-full text-start lg:mt-16 lg:text-base">以上</div>
        </div>
      </div>
    </main>
  );
